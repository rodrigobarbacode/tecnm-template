...
<body style="margin:0;min-height: 500px;">
	<table class="info-table"  id="grupostemas"  ></table>
		    <button type="button" class="btn btn-success btn-lg " data-toggle="modal" data-target=".agregarTema">  <span class="glyphicon glyphicon-plus"></span>Agregar Encuesta</button>
 	
<script>
var pag = "controller/grupoController.php?encuesta=<?php echo $_GET['id'];?>";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <div class="panel panel-default" >
         <div class="negroFondo " style="padding: 10px;color:#fff;">Agrega una nueva Encuesta</div>
            <div class="panel-body">
             
                            
                          <div class="form-left " style="margin-left: 10px;"><strong>Nueva Encuesta  </strong></div>
                                <div class="form-right"><textarea type="text" id="encuestaid" name="encuestaid" class="form-control"  placeholder="Escribe un tema respecto al libro" /></textarea>
                                </div>
                                <div class="form-error"></div>
                            </div> 

                               
                                      <button type="button" class="btn btn-info  btn-sm " id="agregaeltema">  <span class="glyphicon glyphicon-plus"></span> Agregar Encuesta</button> 
                                      <div id="adtema"></div>
                            ...
                            $( document ).ready(function() {
                            	 ...
                            	 $( "#agregaeltema" ).click(function() {
                                      ...
                                      $.ajax({  url:pagina,method:"post", 	cacha: false,
                        	              		   data: { ide:<?php echo $_GET['id'];?>, nombre: $("#encuestaid").val() , encuestap: "registra" },
                        	                    success:function(data){
                        	                        	    var idencuesta =  parseInt(data); 
                        	                  // inserta tareas
                        	                  
                        	                alert("Su encuesta se agrego correctamente");
                        	                location.reload();
                        	        	        }
                        	            });                          // fin ajax temas  ajax
