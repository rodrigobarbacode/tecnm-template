...
if(isset($_SESSION['myusername']) == 1 and $_SESSION['nivel'] == 1 ){
...
<td colspan="7">
<a href="#" onclick="return GB_showCenter('ABC Usuarios', '../abcUsuarios.php',300,700)" class="aAdd">Agregar Usuario</a>
</td>
</tr>
   <tr class="tableTitle" style="background-color:#999">
    ...
    <?php
	$stmt = $db->query('SELECT * FROM personal WHERE nivel <> 1 ');
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    <tr >
    <td width="50%" >
    <a href="#" onclick="return GB_showCenter('ABC Usuarios', '../abcUsuarios.php?id=<?php echo $row['cve_usuario'] ?>',300,700)" class="aEdit"><?php echo $row['usuario'] ?></a>
    </td>
    <td width="50%" ><?php echo $row['password'] ?></td> 
    </tr>
    <?php
