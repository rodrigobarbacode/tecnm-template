...
<ul>
   ...
   <li  class="active"><a href='lista_periodos.php'>Periodos</a></li> 
   <?php
   if ( $_SESSION['nivel'] == 1){?> 
...
<td colspan="7">
<a href="#" onclick="return GB_showCenter('ABC Periodos', '../abcPeriodos.php',400,700)" class="aAdd">Agregar Periodo</a>
</td>
</tr>
   <tr class="tableTitle" style="background-color:#999">
    ...
    <?php
	$stmt = $db->query('SELECT * FROM periodos');
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    <tr >
    <td width="50%" >
    <a href="#" onclick="return GB_showCenter('ABC Periodos', '../abcPeriodos.php?id=<?php echo $row['cve_periodo'] ?>',400,700)" class="aEdit"><?php echo $row['periodo'] ?></a>
    </td> 
    </tr>
    <?php
