...
<body>
    ...
    <div class="modal-dialog">
        ...
        <form id="frmGruposU" class="modalActualizar">
                <div class="form-content">
                <input type="numeric" id="Id" name="Id"  required="required" hidden />
                    <!-- alumno 
                    ...
                    <input type="text" name="ActividadU" id="ActividadU" required="required">
                    </div>
                    ...
                    <input type="text" name="HorarioU" id="HorarioU" required="required">
                    </div>

                    <div class="form-group">
                    <label for="username">Docente</label>
                    <input type="text" name="DocenteU" id="DocenteU" required="required">
                    </div>

                    <div class="form-group">
                    <label for="username">Correo</label>
                    <input type="text" name="CorreoU" id="CorreoU" required="required">
                    </div>
