  ...
  <section class="container">
   ...
   <section class="interes slide ">
	...
	<div class="slide" ><!-- ENLACE DE INTERES -->
       <div class="card">
         <a href="http://www.itmexicali.edu.mx/departamentos/etica/" target="_blank" title="moocs"><img  alt="Noticia" class="card-img-top img-fluid"  src="./img/enlaces_interes/logo_genero.png" alt="Card image cap"></a>
       </div>
     </div>
     <div class="slide" ><!-- ENLACE DE INTERES -->
       <div class="card">
         <a href="http://www.mexicox.gob.mx/courses" target="_blank" title="moocs"><img  alt="Noticia" class="card-img-top img-fluid"  src="./img/enlaces_interes/moocs.png" alt="Card image cap"></a>
       </div>
     </div>
     <div class="slide" ><!-- ENLACE DE INTERES -->
       <div class="card">
         <a href="http://www.itmexicali.edu.mx/quejas/index.htm" title="quejas"><img  alt="Noticia" class="card-img-top img-fluid"  src="./img/enlaces_interes/quejas.png" alt="Card image cap"></a>
       </div>
     </div>

     <div class="slide" ><!-- ENLACE DE INTERES -->
       <div class="card">
         <a href="http://www.itmexicali.edu.mx/SIG/" target="_blank" title="SIG"><img  alt="Noticia" class="card-img-top img-fluid"  src="./img/enlaces_interes/sistema_gestion.png" alt="Card image cap"></a>
       </div>
     </div>
	  <div class="slide" ><!-- ENLACE DE INTERES -->
       <div class="card">
         <a href="http://www.itmexicali.edu.mx/departamentos/contraloria_social/" target="_blank" title="PRODEP"><img  alt="Noticia" class="card-img-top img-fluid"  src="./img/enlaces_interes/contraloria_social.jpg" alt="prodep"></a>
       </div>
     </div>
     <div class="slide" ><!-- ENLACE DE INTERES -->
       <div class="card">
          <a href="http://www.cndh.org.mx/" target="_blank" title="CNDH"><img  alt="Noticia" class="card-img-top img-fluid"  src="./img/enlaces_interes/CNDH.png" alt="Card image cap" ></a>
       </div>
     </div>
