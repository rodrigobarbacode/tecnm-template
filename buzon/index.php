  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="table-wrapper">
        <div class=" table-title " style="background: #6200ff; padding: 5px">
          <div class="row">
            <div class="col-lg-12 text-center">
              <div class="col-sm-12 col-lg-1">
                <a href="http://www.itmexicali.edu.mx/"><img src="img/logo.png" width="46" class="m-0" ></a>
               
             </div>
             <div class="col-sm-12 col-lg-10 "> 
               <div class="row">
                <div class="col-lg-10 ">
                  <h2 class="text-lg-right text-sm-center align-content-center  " >Buzón  de Quejas, Sugerencias y Felicitaciones del ITM</h2>
                </div>

                <div class="col-lg-2 ">
                  <h4 class="text-lg-right  text-sm-center "><a href = "login.php" style="color: white;">Iniciar Sesión</a></h4>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div  class=" col-md-offset-4 col-lg-4 center">
          ...
          <form name="consultadeusuario" id="consultadeusuario" action="#" method='POST'>
               <div class="modal-header">            
            <h4 class="modal-title text-center">Consulta de Quejas, Sugerencias y Felicitaciones</h4>
          </div>
          <div class="modal-body">          
            <div class="form-group text-center">
              <label>Ingrese el No. Control / No. Empleado / Nombre <br>que uso para levantar el Registro</label>
              <input type="text" name="Nuser" id="Nuser" class="form-control " placeholder="No. Control / No. Empleado / Nombre">
            </div>
...
$(document).ready(function () {
 $("#limpiarcon").click(function(event) {
    $("#Nuser").val(""); 
    $("#Nfolio").val(""); 
   });
});
