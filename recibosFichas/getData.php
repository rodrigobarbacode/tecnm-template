		...
		switch($res['STATUS'])
   {
	case 'A':
        ...
        <?php
           ...
           echo "<br /> TECNOLOGICO NACIONAL DE MEXICO<b>";	
		   ...
		   echo "<br /> CONVENIO SANTANDER 2092<b>";		
			...
			echo "<br /> <font size=\"4\"><b>Una vez que pages, espera le fecha publicada para tu registro CENEVAL del paso II"."</b></font>";	
...
<div class="container text-center">
	...
	break;
      ...
      default:  
	  echo "<br /> <font size=\"4\"><b>Teclea tu número de ficha correctamente o haz tu registro primeramente en el SGE"."</b></font>";	
