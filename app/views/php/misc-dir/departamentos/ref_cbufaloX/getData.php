...
<?php 
 ...
 try{
	$sql =  "SELECT * from semestrecero WHERE ALU_CTR = '$nc'" ;
	  $stmt = $conn->query($sql);	 
...
<div class="container text-center">
	...
	break;
	  ...
	  echo "<br /> <font size=\"4\"><b>No eres aspirante registrado para curso CBufalo, si tienes dudas envia un correo a : desarrollo@itmexicali.edu.mx"."</b></font>";	
