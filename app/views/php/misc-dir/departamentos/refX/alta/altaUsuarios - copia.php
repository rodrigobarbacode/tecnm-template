...
<head>
 ...
 <link rel="icon" href="img/ico.png">
        ...
        function pAgregarUsuario(){
        	alert("Haz algo");
        	/*if(confirm("Agregar nuevo usuario?")){
        ...
        function pGuardarUpdatePrivilegios(){
        	if(confirm("Esta seguro de guardar los privilegios?")){
...
<body>
	<?php $op = "1";require_once ('../header.php');?>
	<button>  </button>
		        ...
		        <div class="modal-body">
					...
					<form id="agregarUsuario" action="../php/insertarUsuario.php" method="post" >
						<div class="form-group">
							<h3><small>Usuario.</small></h3>
							<input id="validarUsuario" type="text" name="user" onblur="validarNombreUsuario()" class="form-control" maxlength="300" placeholder="Inserta tu usuario"
								pattern="[a-z*A-Z*0-9*]*"
							required
							/>
							<h3><small>Nombre.</small></h3>
							<input type="text" name="name" class="form-control" maxlength="300" placeholder="Inserta tu nombre"
								pattern="[a-z*A-Z*0-9*[ ]*]*"
							required
							/>
							<h3><small>Clave.</small></h3>
							<input type="text" name="password" class="form-control" maxlength="300" placeholder=" Inserta tu password"
							required
							/>
							<h3><small>Privilegio.</small></h3>
							<input type="text" name="level" class="form-control" maxlength="300" placeholder="Nivel: 1-3"
								pattern="[1-3]*"
							required
							/>
						</div>
	      ...
	      <!-- Modal content-->
			<div class="modal-content">
			    ...
			    <div class="modal-footer">
						...
						<input type="submit" class="btn btn-primary" style="float:right; margin:10px;" value="Actualizar" onclick="pActualizar()" >
