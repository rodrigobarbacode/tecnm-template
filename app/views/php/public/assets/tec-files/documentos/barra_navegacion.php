        ...
        <ul class="navbar-nav ml-auto text-left" >
            <li class="nav-item dropdown " >
                ...
                <div aria-labelledby="navbarDropdown" class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="./documentos/2019/bole19.pdf">
                        Boletín Informativo 2019
                    </a>
                    <a class="dropdown-item" href="./departamentos/transparencia/">
                        Transparencia Y Rendición de Cuentas
                    </a>
                  
                    <a class="dropdown-item" href="./documentos/calendario/CALE_2020-1.pdf">
                        Calendario 2020-1
                    </a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <div aria-labelledby="navbarDropdown" class="dropdown-menu">
					...
					<a class="dropdown-item" href="http://www.itmexicali.edu.mx/documentos/baja_temporal.doc" target="_blank">
                        <span>
                            Formato de baja temporal de la escuela
                        </span>
                    </a>
