...
<div class="datos ">
  <?php
    echo "<h2 class='text-center'>CONVENIO BBVA 1923161 TECNOLOGICO DE MEXICALI</b><h2>";
  echo "<br><b> Nombre del Aspirante: <b>$nombre </b>"; 
    echo "<br>Concepto: <b>$nconcepto</b>";  
    echo "<br>Monto: <b>$$monto</b>";  
	echo "<br>Fecha vigencia: 6 al 9 enero 2023<b></b>";	 
    echo "<br><h3>Referencia de pago: <b>$cadenafinalfinal</b></h3></br>"; 
    ?>
</div>
 ...
 <h4></h4>
 <h4><strong>•BBVA.mx, BBVANETCASH.mx, APP Multipagos BBVA: convenio: 1923161 y tu referencia de la ficha de pago</strong></h4>
 <h4></h4>
 <h4><strong>•Cajeros automáticos BBVA: Opción Servicios -> Convenio: 1923161 -> y tu referencia de pago</strong></h4>
 <h4></h4>
 <h4><strong>•Transferencia entre BBVA: 1923161 y tu referencia de pago</strong></h4>
 <h4></h4>
 ...
 <h4><strong>IMPORTANTE: </strong></h4>
  <h4></h4>
 <h4>Si el pago es con transferencia SPEI, deberás poner en el concepto de pago de tu aplicación tu REFERENCIA DE PAGO: todos los dígitos, para poder identificarte de lo contrario, no será posible registrarte</h4>
    <h4></h4>
   <h4 class="text-center"><strong>  NO PAGES EN OXXO!!!</strong></h4>
    ...
    <div class="text-left">
        ...
        **Alumnos que requieren FACTURA del servicio(R.F.C.).</h4>
        <h4>
            Si requieren FACTURA por el servicio que se está pagando es necesario que envíes el mismo día que hiciste el pago al correo tesoreria@itmexicali.edu.mx el comprobante de depósito, la constancia de situación fiscal y uso CFDI, para su elaboración
