...
<div class="datos ">
  <?php
    echo "<h2 class='text-center'>CONVENIO BBVA 1923161 TEC MEXICALI</b><h2>";
  echo "<br> Nombre del Aspirante: <b>$nombre </b><br>";
    echo "Concepto: <b>$nconcepto</b><br>";
    echo "Monto: <b>$$monto</b> <br>";
  echo "</b>Vig:<br>";
  echo "</b>NOTA: <br>";
    echo "<h3>Referencia de pago: <b>$cadenafinalfinal</b></h3>";
    ?>
</div>
...
<img src="<?php echo $PNG_WEB_DIR.basename($filename);?>">
 ...
 <h4><strong> </strong></h4>
 <h4><strong>•BBVA.mx, BBVANETCASH.mx, APP Multipagos BBVA: convenio: 001923161 y tu referencia de la ficha de pago </strong></h4>
 ...
 <h4><strong>-LAS SUCURSALES NO ACEPTAN PAGOS EN VENTANILLA, UTILIZA LAS OPCIONES ANTERIORES PARA EL PAGO. </strong></h4>
 <h4><strong>-NO PAGAR EN OXXO </strong></h4>
 ...
 <h4><strong> </strong></h4>
    ...
    * *</strong></h3>
    ...
    <div class="text-left">
        <h4>        **Alumnos que requieren FACTURA del servicio(R.F.C.).</h4>
        <h4>
Si requieren FACTURA por el servicio que se está pagando es necesario que envíes el mismo día que hiciste el pago al correo tesoreria@itmexicali.edu.mx el comprobante de depósito, la constancia de situación fiscal y uso CFDI, para su elaboración            
        ...
        <h4>
            Es muy importante atiendas las indicaciones, cualquier duda, contacta al correo: tesoreria@itmexicali.edu.mx   NO HAY DEVOLUCION DEL DINERO.
        </h4>
    </div>
