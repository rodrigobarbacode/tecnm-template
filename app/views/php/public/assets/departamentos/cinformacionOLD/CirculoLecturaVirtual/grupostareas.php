...
<body style="margin:0;min-height: 500px;">
	<table class="info-table"  id="grupostemas"  ></table>
		    <button type="button" class="btn btn-success btn-lg " data-toggle="modal" data-target=".agregarTema">  <span class="glyphicon glyphicon-plus"></span>Agregar Tarea</button>
 	
<script>
var pag = "controller/grupoController.php?tareas=<?php echo $_GET['id'];?>";
     ...
     <div class="panel panel-default" >
         <div class="negroFondo " style="padding: 10px;color:#fff;">Agrega una nueva tarea</div>
            <div class="panel-body">
                     ...
                     <a  class="btn btn-info btn-sm " id="agregalatarea" >  <span class="glyphicon glyphicon-plus"></span> Agregar Tarea</a>
                            ...
                            $( document ).ready(function() {
                            	 ...
                            	 $( "#agregalatarea" ).click(function() {
                                     ...
                                     $.ajax({  url:pagina,method:"post", 	cacha: false,
                        	              	data: { idse:<?php echo $_GET['id'];?> , tarea: $("#tareaa").val() ,valor:$("#valortarea").val() , tareaspost: "registra" },                                           
                        	                success:function(data){
                        	                  // inserta tareasa
                        	            
                        	             
                        	                alert("Su tarea se agrego correctamente (Atencion: Se agregaron +"+$("#valortarea").val()+" pts  al total de puntos de Grupo)");
                        	                
                        	                 $.ajax({  url:pagina,method:"post", 	cache: false,
                        	                          	data: { idgrupo:<?php echo $_GET['id'];?> , pts: "+"+$("#valortarea").val()+"" ,sumagrupo: "registra" },                                           
                        	                             success:function(data){
