...
<div class="container-fluid  p-0 ml-0 mr-0 bg-tecnm">
    <div class="row">
        ...
        <div id="sidebar-holder" class="col-md-2 p-0">
            ...
            <div id="sidebar" class="col-md-12 d-sm-none d-md-none d-lg-none d-xl-block">  
                ...
                <div class="item-style">
                    <a href="#" onclick="toggleSubmenu('objetivos')">
                    <img width="30" height="30" src="https://img.icons8.com/ios-glyphs/100/FFFFFF/user--v1.png" alt="user--v1"/>        
                        Objetivos
                    <img id="objetivos" class="submenu-button" width="20" height="20" src="https://img.icons8.com/ios/50/FFFFFF/expand-arrow--v1.png" alt="expand-arrow--v1"/>
                    </a>
                </div>
                
                <div class="submenu objetivos item-style d-none">
                    <a href="#" onclick="contentToggle('objetivos-norm')">
                ...
                <div class="submenu objetivos item-style d-none">
                    <a href="#" onclick="contentToggle('objetivos-org')">
                ...
                <div class="item-style">
                    <a href="#" onclick="contentToggle('preguntas')">
                ...
                <div class="item-style">
                    <a href="#" onclick="contentToggle('ss')">
                    <img width="30" height="30" src="https://img.icons8.com/ios-filled/50/FFFFFF/water.png" alt="water"/>                        
                        Servicio Social
                    </a>
                </div>
        ...
        <div id="content-holder" class="col-md-9 mx-auto m-4">
            ...
            <!-- Objetivos -->
            <div id="objetivos-norm" class="row yogurt-defase p-2 mt-5 m-3">
            ...
            <!-- Objetivos Org -->
            <div id="objetivos-org" class="row yogurt-defase p-2 mt-5 m-3">
                <div class="col-md-12 pt-4 pr-4 pl-4">
            ...
            <!-- Acordion de Datos -->
            <div id="preguntas" class="row yogurt-defase p-2 mt-5 m-3">
            ...
            <div id="ss" class="row yogurt-defase p-2 mt-5 m-3">
