...
<html lang="es">
  <head>
	...
	<meta charset="UTF-8">
	<title>TecNM | Tecnolaógico Nacional de México</title>
	...
	<link rel="stylesheet" href="/public/icons/iconos.css">
	...
	<style> 
		...
		.slick-slide {
		 ...
		 .anexo > .slick-prev:before { /* Flecha azul - lado izquierdo */
			background: url('/public/img/flechas/izquierda_gris.png');
			background-size: contain;
			color: transparent;
		}
	   
		 .anexo > .slick-next:before { /* Flecha azul - lado derecho */
			background: url('/public/img/flechas/derecha_gris.png');    
			background-size: contain;
			color: transparent;
		}
		 
		 #noticias > .slick-prev:before { /* Flecha azul - lado izquierdo */
			background: url('/public/img/flechas/izquierda_azul.png');
			background-size: contain;
			color: transparent;
		}
	   
		 #noticias > .slick-next:before { /* Flecha azul - lado derecho */
			background: url('/public/img/flechas/derecha_azul.png');    
			background-size: contain;
			color: transparent;
		}
  ...
  <body>
				...
				<div class="idiomas text-right">
					...
					<!-- Traductor -->
						<a href='index?idioma=mandarin#googtrans(es|zh-CN)'>
							<img style='height:6%;width:6%' src='/public/img/encabezado/china-icono.png' title='Mandarín'
								alt='Idioma Mandarín'>
						</a>
						<a href='index?idioma=ingles#googtrans(es|en)'>
							<img style='height:6%;width:6%' src='/public/img/encabezado/usa-icono.png' title='Inglés'
								alt='Idioma Inglés'>
						</a>
						<a href='index?idioma=frances#googtrans(es|fr)'>
							<img style='height:6%;width:6%' src='/public/img/encabezado/francia-icono.png' title='Francés'
								alt='Idioma Francés'>
						</a>
						<a href='index?idioma=español#googtrans(es|es)' class='mr-3'>
							<img style='height:6%;width:6%' src='/public/img/encabezado/mexico-icono.png' title='Español'
								alt='Idioma Español'>
						</a>
					<!--  -->
    ...
    <nav class="navbar navbar-expand-xl navbar-light bg-white" id="main_navbar2">
        ...
        <div class="collapse navbar-collapse pl-5 pl-lx-0" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"> 
					<a class="nav-link active" href="#"> Nivel 1 </a> 
				</li>
        ...
        <div class="collapse navbar-collapse pl-5 pl-lx-0" id="navbarSupportedContent2">
            <ul class="navbar-nav mr-auto">
				...
				<div class='d-none d-lg-block' id="tecnmblanco" style="visibility:hidden; ">
					<img loading='lazy' alt="TecNM" style="width: 90px; height:auto;" src="/public/img/logos/tecnm_menu.png" />
				</div>
	...
	<section class='one-time principal border'>
		...
		<div class='carousel-item active' style='background-image: url("/public/img/slider/IGUALDAD_Y_NO_DISCRIMINACION.jpg");'>
			<a href='/public/img/slider/IGUALDAD_Y_NO_DISCRIMINACION.jpg' target='_blank'>
				<div style='width:100%; height:100%'></div>
			</a>
		</div>
		
		<div class='carousel-item' style='background-image: url("/public/img/slider/ENTORNO.jpg");'>
			<a href='/public/img/slider/ENTORNO.jpg' target='_blank'>
				<div style='width:100%; height:100%'></div>
			</a>
		</div>
	...
	<div class='container m-0 m-auto mb-3'>
		...
		<div class='row w-100 justify-content-center bg-light pb-3 m-0'>
			...
			<div class='center slider my-0' id='noticias'>
				...
				<div class='row justify-concent-center' style='posicion: relative;'>
					...
					<div class='col-12'>
						<img class='img-fluid mx-auto w-100' style='height: 150px;' src='/public/img/noticias/1/A.jpg' alt='' />
					</div>
				...
				<div class='row justify-concent-center' style='posicion: relative;'>
					...
					<div class='col-12'>
						<img class='img-fluid mx-auto w-100' style='height: 150px;' src='/public/img/noticias/2/A.jpg' alt='' />
					</div>
				...
				<div class='row justify-concent-center' style='posicion: relative;'>
					...
					<div class='col-12'>
						<img class='img-fluid mx-auto w-100' style='height: 150px;' src='/public/img/noticias/3/A.jpg' alt='' />
					</div>
				...
				<div class='row justify-concent-center' style='posicion: relative;'>
					...
					<div class='col-12'>
						<img class='img-fluid mx-auto w-100' style='height: 150px;' src='/public/img/noticias/4/A.jpg' alt='' />
					</div>
				...
				<div class='row justify-concent-center' style='posicion: relative;'>
					...
					<div class='col-12'>
						<img class='img-fluid mx-auto w-100' style='height: 150px;' src='/public/img/noticias/5/A.jpg' alt='' />
					</div>
		...
		<div class='row w-100 justify-content-center bg-light py-3 m-0'>
			...
			<div class='media-container-row text-center'>
				...
				<a class='twitter-timeline' data-lang='es' data-width='350' data-height='525' data-dnt='true' data-theme='light' href='https://twitter.com/TecNM_MX?ref_src=twsrc%5Etfw'></a>
	...
	<footer class='border bg-tecnm footer'>
		...
		<div class='row m-0 justify-content-center p-3'>
			...
			<div class='h6 col-12 col-lg-6 '>
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3764.168286745534!2d-99.17093298526561!3d19.36186458692447!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d1ff2a32fb54cd%3A0xc032b9cecdd00867!2sTecnol%C3%B3gico%20Nacional%20De%20M%C3%A9xico!5e0!3m2!1ses-419!2smx!4v1569527710329!5m2!1ses-419!2smx" width="100%" height="400" frameborder="0" style="border:0;"></iframe>
			</div>
