...
<?php 
 ...
 try{
	$sql =  "SELECT * from fichas WHERE ALU_CTR = '$nc'" ;
	  $stmt = $conn->query($sql);	 
		...
		switch($res['STATUS'])
   {
	case 'A':
        ...
        <?php
           ...
           echo "<br /> GOBIERNO DE MEXICO >>> TECNOLOGICO NACIONAL DE MEXICO / MEXICALI<b>";	
			echo "<br>BANCO SANTANDER</br>" ;
		   
		   echo "<br /> CONVENIO SANTANDER 2092<b>";		
		    echo "<br /><font size=\"5\"> N&uacute;mero de Solicitud: <b>" .  $res['ALU_CTR'] . "</b></font>" ;
			...
			echo "  <br /><font size=\"6\"><b>Referencia:<div  id='lineaPHP'>".$linea . "</div></b></font> ";
			echo "<br /> <font size=\"4\"><b>Sigue las instrucciones publicadas para tu proceso de ingreso, es muy importante tomes en cuenta las fechas correspondientes y esperes !!!!!"."</b></font>";	
...
<div class="text-left">
<h4>
**Alumnos que requieren FACTURA del servicio(R.F.C.), envia comprobante del deposito o transferencia el mismo día del pago al correo: tesoreria@itmexicali.edu.mx con todos los datos fiscales .</h4>
<h4>
...
<div class="container text-center">
	...
	break;
      ...
      default:  
	  echo "<br /> <font size=\"4\"><b>Teclea tu número de ficha correctamente o haz tu registro primeramente en el Mindbox"."</b></font>";	
