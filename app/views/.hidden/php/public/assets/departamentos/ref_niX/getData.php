		...
		switch($res['STATUS'])
   {
	case 'A':
        ...
        <?php
           ...
           echo "<br /><font size=\"4\"> GOBIERNO DE MEXICO  //	SECRETARIA DE EDUCACION PUBLICA<b></font>";	
           echo "<br /><font size=\"3\"> TECNOLOGICO NACIONAL DE MEXICO CAMPUS MEXICALI<b></font>";	
           echo "<br /><font size=\"3\"> BANCO SANTANDER<b></font>";	
		   echo "<br /> <b>";		

		   echo "<br /> CONVENIO SANTANDER 2092<b>";		
		    echo "<br /> N&uacute;mero de Solicitud: <b>" .  $res['ALU_CTR'] . "</b>" ;
            echo "<br /> Nombre del aspirante: <b>" .  $res['ALU_NOM'] . "</b>";
            echo "<br /> Concepto: <b>" . $res['ALU_CONCEPTO'] . "</b>";
            echo "<br /> Monto: <b> $" . $res['ALU_MONTO'] . ".00</b>";
			echo "<br /> Vigencia: <b> " . $res['ALU_PERIODO'] . "</b>";
			 echo "<br /> <b>";	
			echo "<br /> Observaciones: <b> " . $res['ALU_OBS'] . "</b>";
			...
			echo "  <br /><font size=\"6\"><b>Linea:<div  id='lineaPHP'>".$linea . "</div></b></font> ";
...
<div class="text-left">
<h4>
**Alumnos que requieren FACTURA del servicio(R.F.C.), envia comprobante del deposito o transferencia al correo: tesoreria@itmexicali.edu.mx con Cedula Fiscal .</h4>
<h4>
</h4>
<h4>
**Si haces caso omiso a las instrucciones y pagas la inscripción, será tu responsabilidad, por lo que la Secretaría de Educación Pública no se hace responsable de hacer válida tu inscripción, ni de la devolución del dinero.
</h4>
</div>
<h3>
<strong>
...
<div class="container text-center">
	...
	break;
      ...
      default:  
	  echo "<br /> <font size=\"4\"><b>Teclea correctamente tu numero de ficha"."</b></font>";	
	  echo "<br /> <font size=\"4\"><b>No eres aspirante publicado, consulta con desarrollo académico en desarrollo@itmexicali.edu.mx"."</b></font>";	
