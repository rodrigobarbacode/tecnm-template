      ...
      <?php
  		...
  		?>
              ...
              <div class="container">
                ...
                <form class="form-signin" action="getData.php" method="post">
                        <h2 class="form-signin-heading">SEP TecNM INSTITUTO TECNOLOGICO DE MEXICALI<br/></h2>
						<h2 class="form-signin-heading">Recibo para el curso CBufalo<br/></h2>
                       
                        <label for="nocontrol" class="sr-only">No. de Solicitud</label>
                            <input type="text" id="nocontrol" name="nocontrol" class="form-control" placeholder="No. de Ficha" required autofocus>
