        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div aria-labelledby="navbarDropdown" class="dropdown-menu">
                    ...
                    <!-- Opción: Repositorio Institucional del TecNM -->
                    ...
                    <!-- Opción: Nuevo Reglamento del Estudiante -->
