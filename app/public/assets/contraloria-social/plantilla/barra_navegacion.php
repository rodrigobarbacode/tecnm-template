        ...
        <ul class="navbar-nav ml-auto text-left" >
            <li class="nav-item dropdown " >
                ...
                <div aria-labelledby="navbarDropdown" class="dropdown-menu">
					...
					<a class="dropdown-item" href="./documentos/2023/CALE 20231.png">
                        Calendario 2023-1
                    </a>
            ...
            <li class="nav-item dropdown">
                ...
                <div aria-labelledby="navbarDropdown" class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="http://www.itmexicali.edu.mx/departamentos/pagobbva_alu/">
                        <span>
                            Lineas de pago de servicios - temporal
                        </span>
                    </a>
                    <a class="dropdown-item" href="https://financieros.itmexicali.edu.mx/pagos">
                        <span>
						    Lineas de pago de nuevo ingreso y cursos de verano
                        </span>
                    </a>
					...
					<a class="dropdown-item" href="./departamentos/escolares/escolares.html">
					    ...
					    <a class="dropdown-item" href="http://www.itmexicali.edu.mx/comite/" target="_blank">
                        <span>
                            Formatos de solicitud CA
                        </span>
                    ...
                    <a class="dropdown-item" href="./documentos/2022/aportaciones2022.pdf" target="_blank">
                        <span>
			...
			<li class="nav-item dropdown">
                <a aria-expanded="false" aria-haspopup="true" class="nav-link dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" href="#" id="navbarDropdown" role="button">
                 ...
                 <div aria-labelledby="navbarDropdown" class="dropdown-menu">
				<a class="dropdown-item" href="http://www.itmexicali.edu.mx/img/banners/2023/documentos/nuevo_ingreso.pdf">
