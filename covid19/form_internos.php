...
.dropdown-menu {
  ...
  messages: {
    usr: "Introducir No. de Control. / No. Empleado", 
  },
    ...
    $('#SubForm').click(function() {
      form.submit();
		...
		function validarNoControl(){
        	...
        	$.post( "php/validarNoControl.php",{'x':''+usr+''},function( result ) {
...
<div class="container ">
  ...
  <h3 class="text-info">ALUMNOS/PERSONAL</h3>
                                        
  <form style="font-weight:bold; font-size:14pt;" method="post" id="dischargeform" action="save_form_internos.php">
  
  <input type="number" class="form-control" id="usr" placeholder="No.Control / No. Empleado " name="usr"/>
