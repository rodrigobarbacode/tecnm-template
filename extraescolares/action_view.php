...
$tabla="";
 ...
 $sql= "SELECT a.*,ac.*,aa.*  FROM actividades_alumno aa inner join alumnos a on a.ALU_CTR = aa.id_alumno inner join actividades ac on ac.id_actividad = aa.id_actividad   WHERE aa.id_alumno = '".$no_control."' AND ac.periodo = 20201";
$stmt = $conn->query($sql);
