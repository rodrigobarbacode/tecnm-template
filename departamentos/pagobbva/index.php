    ...
    <div class="container-fluid">	
		 <div class="container">
          ...
          <form  class="form-signin" action="validar.php" method="POST">
            ...
            <h2 class="modal-title text-center">Descarga tu línea de pago de reinscripción BBVA</h2>
            <h3 class="modal-title text-center">Solamente requieres tu número de control para descargar tu recibo bancario</h3>
          </div>
...
<!-- Ultima actualizacion 10/01/22 by yerman>
