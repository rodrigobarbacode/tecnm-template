...
<div class="container d-flex justify-content-center"> 
    ...
    <?php
	$stmt = $conn->query("select count(aa.id_actividad) as total, a.* from actividades a left join actividades_alumno aa on aa.id_actividad = a.id_actividad where a.periodo=20201 and a.RFC='".$_SESSION["rfc"]."' GROUP by a.id_actividad");
