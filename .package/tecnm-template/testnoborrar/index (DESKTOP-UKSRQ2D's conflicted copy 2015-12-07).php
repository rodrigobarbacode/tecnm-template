...
<head>
    ...
    <title>Blog - Sylvia Melendrez</title>
							...
							?>
							 ...
							 <div class="col-md-4 col-sm-6 portfolio-item text-center">
								<a href="#portfolioModal3" class="portfolio-link edit" data-toggle="modal" data="<?php echo $post['id_post']?>">
									...
									<img src="<?php echo $post['imagen']?>" class="img-responsive" alt="">
								</a>
						...
						foreach($posts as $post){
							...
							?>
							 ...
							 <div class="col-md-4 col-sm-6 portfolio-item">
								<a href="#portfolioModal1" class="portfolio-link" data-toggle="modal" data ="<?php echo $post['id_post']?>">
									<div class="portfolio-hover">
										<div class="portfolio-hover-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Licenciada en Derecho y estudiante de Psicología Clínica.   Paciente e impaciente.   Controlada y descontrolada; mal hablada siempre que se puede.   En fin, aprendiendo en este mundo ambivalente...     Gozo la comida,   reírme a carcajadas   y los cielos que me hacen detenerme.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
