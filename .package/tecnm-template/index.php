<!-- Developed By: Francisco Ruiz - German Avila - Rodrigo Barba -->
<!DOCTYPE html>
<html lang="es">
...
<body>
  ...
  <div id='occ-widget'>
    <script id="bolsa-widget" type="text/javascript" src="http://jobdiscovery-widget-occ.occ.com.mx/button-bundle.js" key="1YidX3sOhZ2tXuCzh1SBgW3JIkf">
    </script>
  </div>
