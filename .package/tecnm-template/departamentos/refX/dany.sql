...
`cve_conceptos` int(11) NOT NULL,
  ...
  `ALU_NOM` varchar(80) COLLATE utf8_bin NOT NULL,
  `ALU_MONTO` float NOT NULL,
  `ALU_CVE` bigint(20) NOT NULL,
...
INSERT INTO `conceptos` (`cve_conceptos`, `cve_usuario`, `ALU_NOM`, `ALU_MONTO`, `ALU_CVE`, `CLAVE_SEP`, `CLAVE_COMP`) VALUES
