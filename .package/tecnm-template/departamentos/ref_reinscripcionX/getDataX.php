	...
	case 'A':
        ...
        <?php
		   ...
		   echo "<br /> CONVENIO SANTANDER 2092<b>";		
            ...
            $linea = mod22($res['ALU_CTR'],$condensacioncita,$res['ALU_MONTO']);
            echo "  <br /><font size=\"4\"><b>Linea referenciada:<div  id='lineaPHP'>".$linea . "</div></b></font> ";
			
			echo "<br /> <font size=\"4\"><b>-Si cursas residencia profesional solamente, solicita desde tu correo institucional tu recibo bancario al correo reciboresidencia@itmexicali.edu.mx "."</b></font>";	
			echo "<br /> <font size=\"4\"><b>-En caso tengas que hacer ajustes de horarios, sige las instrucciones publicadas "."</b></font>";	
			echo "<br /> <font size=\"4\"><b>-Si haces trasferencia electrónica, sige las instrucciones para que identifiquen tu pago. "."</b></font>";	
			echo "<br /> <font size=\"4\"><b>- "."</b></font>";	
			echo "<br /> <font size=\"4\"><b>-SELECCION DE MATERIAS CASOS ESPECIALES Y PAGOS TARDIOS, VERIFICAR INSTRUCCIONES DE CASOS ESPECIALES . "."</b></font>";	
			echo "<br /> <font size=\"4\"><b>-NO DEBES PAGAR SI TU ESTATUS ES BAJA, O TIENES CURSOS ESPECIALES REPROBADOS . "."</b></font>";	
...
<div class="container text-center">
	...
	break;
      ...
      default:  
	  echo "<br /> <font size=\"4\"><b>No puedes descargar el recibo, teclea tu número de ctrl correctamente, o, si tienes cambio de carrera elimina la letra C del numero de ctrl "."</b></font>";	
	  	  echo "<br /> <font size=\"4\"><b>o, Examenes especiales reprobados"."</b></font>";	
	  echo "<br /> <font size=\"4\"><b>o, Presenta adeudos en RecFinancieros"."</b></font>";	
	  echo "<br /> <font size=\"4\"><b>o, no cursaste materias el semestre pasado"."</b></font>";	
