...
try {
    ...
    $stmt = $conn->prepare("SELECT ALU_NOM FROM `quejas`.`daluQuejas` WHERE ALU_CTR = '$nocontrol';");
    $stmt->execute();
...
$sql = "INSERT INTO `quejas`.`quejasAlumnos` (`FECHA_QUEJA`, `CONTROL`, `QUEJA`, `CORREO`) VALUES ('$fecha', '$nocontrol', '$queja', '$correo');";//insertar en tabla";
