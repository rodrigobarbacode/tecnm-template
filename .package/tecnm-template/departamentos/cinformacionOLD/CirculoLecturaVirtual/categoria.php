...
$arg = '';
$arg = $_GET['id'];
$libro = GetJson('http://localhost/CirculoLecturaVirtual/controller/bibliotecaController.php?libc=',$arg,""); // $row[0]->img    GRUPO JSON
...
<head>
    ...
    <title>Biblioteca Virtual Instituto Tecnologico de Mexicali | <?php echo $categoria; ?></title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Categoria: <?php echo $categoria;?></a>
            </div>
...
<div class="wrapper" id="wrapper" style="margin-top: -20px; color:#ffffff;text-align: left;">
 	<header > Categoria: <?php echo $categoria;?>
    ...
    <div class="containerr">
       ...
       for($x=0;$x<count($libro);$x++){
       	if($libro[$x]->img==""){
       		$img = "img/libro2.png";
       	}else{
       		$img = "up/".$libro[$x]->img;
       	}
       	echo '<div class="box">'.$libro[$x]->titulo.'
       	
       	<a href="lib?id='.$libro[$x]->id.'" ><img border="0" src="'.$img.'" width="200" style=" padding:5px;   float: left;" ></a>
       	</div>';
       }
...
<!-- 	<script src="js/bootstrap.min.js"></script> -->
	  <script type="text/javascript" src="https://bootswatch.com/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
	    <script type="text/javascript" src="https://bootswatch.com/assets/js/bootswatch.js"></script>
		 <!-- fin bootstrap fin -->
