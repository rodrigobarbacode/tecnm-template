...
<!-- Comentando la linea de modal_aviso el modal ya no se mostrara poner // antes del require ejemplo:::   <?php //require_once 'modal_aviso.php'?>-->
 ...
 <!--    desactivado modal aviso por los comentarios <?php require_once 'modal_aviso.php'?>    -->
  ...
  <div class="icon-bar">
    ...
    <a href="https://www.youtube.com/channel/UCj0YfvUhWQaH94SrAuBb9OA" title="youtube ITM"><img class="rounded-circle" src="./img/iconos/youtube.ico"></a>
