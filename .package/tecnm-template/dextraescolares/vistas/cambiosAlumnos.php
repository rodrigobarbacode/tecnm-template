...
if(isset($_SESSION['nombre']))
{
    ...
    $alumno = $_SESSION['nombre'];
        $sql ="SELECT alumno.noControl,alumno.paterno, alumno.materno, alumno.nombre, alumno.fecha, alumno.estatus FROM `alumno` ";
    ...
    <div class="modal-dialog">
        ...
        <form id="frmAlumnosU" class="modalActualizar">
                <div class="form-content">
                    ...
                    <!-- Pago -->
                    <div class="form-group">
                        <label for="username">Estatus del Pago</label>
                        <select name="pagoU" id="pagoU">
