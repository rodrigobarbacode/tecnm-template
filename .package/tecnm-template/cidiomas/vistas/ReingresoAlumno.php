...
if(isset($_SESSION['nombre']))
{
    ...
    {
        $idgrupo=$_POST['grupo'];
        $sql ="SELECT alumno.noControl,alumno.paterno, alumno.materno, alumno.nombre, semestre.nivel FROM `alumno` INNER JOIN semestre on semestre.noControl = alumno.noControl
        WHERE semestre.nivel = '$idgrupo'";
    ...
    <form method="post" class="tabla">
        <div class="form-toggle"></div>
            <div class="form-panel one">
                ...
                <h1>Control de Alumnos Reingreso</h1>
                <div class="form-group">
                    <label for="username">Nivel</label>
                    <select class="form-control" name="grupo" id="grupo">
                        <option value="A">Selecionar Nivel</option>
...
<div class="modal fade" id="calificar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Cambiar de Grupo</h5>
        ...
        <form id="frmReingresoU" class="modalActualizar">
                <div class="form-content">
                    ...
                    <!-- Grupo -->
                    <div class="form-group">
                    <label for="username">Grupo y Nivel</label>
                    <select name="grupoU" id="grupoU">
                        <option value="A">Selecionar Grupo</option>
                        <?php
                            $alumno = $_SESSION['nombre'];
                            $lista = "SELECT idGrupo, Nombre, Nivel, Horario FROM grupos";
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" id="btnRegistrar">Gruardar Cambios</button>
        </div>
        </div>
    </div>
    </div>
