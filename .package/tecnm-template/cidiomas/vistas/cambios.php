...
if(isset($_SESSION['nombre']))
{
    ...
    $alumno = $_SESSION['nombre'];
        $sql ="SELECT alumno.noControl,alumno.paterno, alumno.materno, alumno.nombre FROM `alumno` ";
...
<div class="modal fade" id="calificar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Ingrear al Grupo</h5>
