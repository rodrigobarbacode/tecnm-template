...
<div class="datos ">
  ...
  echo "<br> Nombre del Aspirante: <b>$nombre </b><br>";
    echo "Concepto: <b>$nconcepto</b><br>";
...
<img src="<?php echo $PNG_WEB_DIR.basename($filename);?>">
 ...
 <br><br>
<center>
 <h2 style="color:#FF0000"><strong>FORMAS DE HACER TU PAGO:</strong></h2></center>
  <h3><strong>1. Ventanilla, BBVA.mx, BBVANETCASH.mx, APP Multipagos BBVA: convenio: 001923161 y tu referencia de la ficha de pago</h3><strong>
<h3><strong>2. Cajeros automáticos BBVA: Opción Servicios -> Convenio: 001923161 -> y tu referencia de pago</h3><strong>
<h3><strong>3. Transferencia entre BBVA: 001923161 y tu referencia de pago</h3><strong>
<h3><strong>4. Transferencia SPEI desde cualquier banco a la CLABE INTERBANCARIA: 012914002019231612, tu referencia colocarla en el CONCEPTO<h/3><strong>
IMPORTANTE:
Si el pago es con transferencia SPEI, deberás poner en el concepto de pago de tu aplicación tu REFERENCIA DE PAGO: 18 dígitos, para poder identificarte de lo contrario, no será posible registrarte
<br>
<br>
<br>
<center>
<h2  style="color:#FF0000"><strong>NO PAGES EN OXXO!!!</h2><strong>
</strong></h3>
</center>
    ...
    * *</strong></h3>
    ...
    <div class="text-left">
        ...
        **Alumnos que requieren FACTURA del servicio(R.F.C.).</h4>
        <h4>
            Si requieren FACTURA por el servicio que se está pagando, es necesario enviar EL MISMO DÍA DEL PAGO  al correo cursosdeverano@itmexicali.edu.mx 
			el comprobante de depósito, y los CONSTANCIA DE SITUACION FISCAL, y uso del CFDI, para su elaboración.
			Es muy importante atiendas las indicaciones, cualquier duda, contacta al correo: cursosdeverano@itmexicali.edu.mx NO HAY DEVOLUCION DEL DINERO.
